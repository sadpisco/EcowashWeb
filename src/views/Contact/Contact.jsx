...
export default function Contact() {
    return (
        <main className="w-screen min-h-screen flex flex-col items-center justify-between">
            ...
            <body className={`${styles.background} bg-slate-800  h-[600px] w-full flex flex-col items-start justify-center`} >
                <section className={`${styles.divContact} flex flex-row items-center justify-around p-[5vh] h-[370px] w-[800px]`}>
