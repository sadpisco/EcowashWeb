        ...
        <section className="flex flex-col justify-around items-center h-auto xl:flex-row">
            ...
            <section className=" mt-2 h-44 w-auto">
                ...
                <section className="flex flex-row items-center justify-between w-[360px] mt-2 ">
                    ...
                    <a href='https://www.facebook.com/GrupoFachasa' target="_blank" className = "text-white flex flex-row items-center justify-between h-auto min-w-[115px] p-2 bg-sky-700 rounded-sm shadow-lg shadow-black">
                        <FacebookIcon />
                        <h3 className = "text-white">Facebook</h3>
                    </a>
                    <a href='https://www.instagram.com/ecowash.pe/' target="_blank" className = "text-white flex flex-row items-center justify-between h-auto min-w-[115px] p-2 bg-orange-600 rounded-sm shadow-lg shadow-black">
                        <InstagramIcon />
